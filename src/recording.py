...
def test_gestures(second=30):
    return [Recording('stand', 'stand', n_frames=90),
            Recording('jump', 'jump', n_frames=20),
            Recording('jump', 'jump', n_frames=20),
            Recording('stand', 'stand', n_frames=90),
            Recording('jump', 'jump', n_frames=20),
            Recording('jump', 'jump', n_frames=20),
            Recording('jump', 'jump', n_frames=20)]
...
def random_mock_gestures(second=30):
    ...
    gestures = [
            ...
            Recording('walkf', 'walk forward', n_frames=randt()),
            Recording('walkf', 'walk forward', n_frames=randt(2)),
            Recording('walkf', 'walk forward', n_frames=randt(1.5)),
            Recording('walkf', 'walk forward', n_frames=randt(3)),
            Recording('walkf', 'walk forward', n_frames=randt(2)),
            Recording('walkf', 'walk forward', n_frames=randt()),
            Recording('walkf', 'walk forward', n_frames=randt(1.5)),
            Recording('walkf', 'walk forward', n_frames=randt(1.5)),
            Recording('walkf', 'walk forward', n_frames=randt(1.5)),
            Recording('runf', 'run forward', n_frames=randt()),
            Recording('runf', 'run forward', n_frames=randt()),
            Recording('runf', 'run forward', n_frames=randt(3)),
            Recording('runf', 'run forward', n_frames=randt(2)),
            ...
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            ...
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumpb', 'jump', n_frames=randt(0.5)),
            Recording('jumps', 'hop', n_frames=randt(0.5)),
            Recording('jumps', 'hop', n_frames=randt(0.5)),
            Recording('jumps', 'hop', n_frames=randt(0.5)),
            Recording('jumps', 'hop', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            ...
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('kick', 'kick', n_frames=randt(0.5)),
            Recording('duck', 'duck', n_frames=randt(0.5)),
            Recording('duck', 'duck', n_frames=randt(0.5)),
            Recording('duck', 'duck', n_frames=randt(0.5)),
            Recording('duck', 'duck', n_frames=randt(0.5))
    ]
